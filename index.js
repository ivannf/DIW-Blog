...
var boton = document.getElementById('botonVideo');
console.log('estas en index.js');

boton.addEventListener('click', () => {
    console.log('Dentro de la funcion cerrarVideo()');
    video.remove();
    let texto = document.getElementById('contenedorVideo');
    texto.remove();
});
